...
class DatabaseInitializer:
    ...
    TABLES_DDL = {
        ...
        "xy_accounts": """
            CREATE TABLE IF NOT EXISTS xy_accounts (
                ...
                proxy_force_enabled TINYINT(1) NOT NULL DEFAULT 0 COMMENT '强制使用代理，代理不可用时禁止直连',
    ...
    COLUMN_MIGRATIONS = {
        ...
        "xy_accounts": [
            ...
            ("proxy_force_enabled", "TINYINT(1) NOT NULL DEFAULT 0 COMMENT '强制使用代理，代理不可用时禁止直连'", "proxy_pass"),
            ("message_expire_time", "INT DEFAULT 3600 COMMENT '相同消息等待时间(秒)'", "proxy_force_enabled"),
